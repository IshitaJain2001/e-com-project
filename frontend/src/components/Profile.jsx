                    ...
                    <div className="form-grid">
                      ...
                      <div style={{ position: "relative" }}>
                        ...
                        <span
                          ...
                          style={{ position: "absolute", right: "12px", top: "50%", transform: "translateY(-50%)", cursor: "pointer", color: "rgba(250,250,250,0.6)" }}
                        >
                          {showPassword ? "🙈" : "👁️"}
                        </span>
                      </div>
                      ...
                      <div className="profile-pic">
                        <label>Profile-:</label>
                        <input type="file" onChange={(e) => setForm({ ...form, picture: e.target.files[0] })} />
                      </div>
      ...
      <div className="profile-card">
        <div className="welcome-card">
          <div className="picture-div">
            ...
            <button className="edit-icon"><MdCameraEnhance /></button>
          </div>
