...
export default function Cart() {
  ...
  const handleDelete = async (addrId) => {
    const confirmDel = window.confirm("Are you sure you want to delete this address?");
    if (!confirmDel) return;

    try {
      const res = await fetch(`https://e-com-project-msn4.onrender.com/address/delete/${addrId}`, {
        method: "DELETE",
        credentials: "include",
      });
      const data = await res.json();
  ...
  return (
    <div style={{ maxWidth: "600px", margin: "40px auto", padding: "20px" }}>
      <h2 style={{ textAlign: "center", marginBottom: "20px" }}>Your Addresses</h2>
        ...
        addresses.map((addr) => (
          <div
            ...
            style={{
              ...
              cursor: "pointer",
              backgroundColor:
                selectedAddress?._id === addr._id ? "#e8f5e9" : "#fff",
